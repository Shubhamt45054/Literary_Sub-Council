...
const devTeamMembers = [
  ...
  { name: "Prashant Singh", linkedin: "prashant-singh-269050267/", instagram: "the_red_tshirt_guy/" },
];

const renderTeamList = (teamMembers) => (
  <ul className="flex flex-col font-light m-2">
    {teamMembers.map((member, index) => (
      <li key={index} className="flex items-center">
        <span className="hover:text-emerald-600">{member.name}</span>
        {member.linkedin !== "#" && (
          <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="ml-2 flex items-center">
            <span className="mr-1 hover:text-blue-700 text-blue-500">
              <FaLinkedin />
            </span>
          </a>
        )}
        {member.instagram !== "#" && (
          <a href={member.instagram} target="_blank" className="hover:text-pink-700 text-pink-500 ml-1">
            <FaInstagram />
          </a>
        )}
      </li>
...
const services = [
  ...
  // },
  {
    ...
    title: "Magazine",
    icon: mobile,
    data: () => renderTeamList(magazineTeamMembers),
  },
...
const feedbacks = [

  {
    ...
    heading: ["About"],
    time : ["Time and Venue"],
    timeDetails : ["09-04-2025, 9:00-9:15, New Auditorium"],
    point: [
    ...
    // subheading22: ["Judging Criteria:"],
    // judging12: ["he writeups would be judged based on the following points- -Story Structure-Creativity and Content -Vocabulary and Language -Relevance to theme -Overall Impact"],
    rules2: [],
    heading3: ["Prizes"],
...

  {
    ...
    iconBg: "#383E56",
    time : ["Time and Venue"],
    timeDetails : ["09-04-2025, 9:30-10:30, New Auditorium"],
    heading: ["About"],
    point: [
  ...
  },
  {
    ...
    iconBg: "#383E56",
    time : ["Time and Venue"],
    timeDetails : ["09-04-2025, 10:30-11:30, New Auditorium"],
    heading: ["About"],
    point: [
  ...
  },
  {
    ...
    iconBg: "#383E56",
    time : ["Time and Venue"],
    timeDetails : ["09-04-2025, 11:30-01:30, New Auditorium"],
    heading: ["About"],
    point: [
      "The event 'Likhe Jo Khat Tujhe' is a celebration of the timeless art of letter writing, poetry, and literary expression. It aims to revive the charm of handwritten letters and provide a platform for participants to express their emotions through words.",
  "Participants will have the opportunity to showcase their creativity, connect with others through heartfelt expressions, and explore the beauty of human emotions conveyed through letters and poetry.",
 ],
    heading1: ["Guidelines"],
    subheading1: [],
    rules: [
  "Open to all literature enthusiasts, poets, and writers.",
  "Participants must register before the event; late entries will not be accepted.",
  "Submissions can be in Hindi or English (choose one).",
  "Plagiarism is prohibited; letters must be original and self-written.",
  "Handwritten letters are encouraged for aesthetic appeal.",
  "Each round will have a fixed duration for writing or performance.",
  "Content must be respectful and appropriate; offensive language is not allowed.",
  "Judging will be based on creativity, emotional depth, and presentation."
],
    heading2: ["Rounds"],
    // judging0: [],
    subheading2: ["Round 1: Dil Ki Baat Khat Ke Saath (Emotional Letter Writing):"],
    judging: [
      "Participants will receive a sealed envelope containing a surprise letter prompt.",
      "They must write a meaningful letter within 15 minutes.",
      "The letter can be addressed to a person, a memory, an object, or even a fictional character.",
    ],

    subheading21: ["Round 2: Khat Mein Shayari (Poetic Letter Writing Round):"],
    judging1: [
  "Participants must write a poetic letter, which can rhyme, follow a meter, or be free verse.",
  "The theme will be provided on the spot.",
  "Participants will have 20 minutes to write the letter.",
],

    subheading22: ["Round 3: Khamosh Alfaz, Mehsoos Karo (Letter Exchange & Interpretation Round):"],
    judging12: [
  "Each participant will randomly pick a sealed anonymous letter written by another contestant.",
  "They must read the letter aloud and interpret its emotions in front of the judges.",
  "Before reading, the participant must write a response letter, creating an emotional dialogue between two unknown writers.",
 ],

    rules2Heading :["Final Round: Likhe Jo Khat Tujhe Live Performance (Dramatic Letter Reading Round) "],
    rules2: [
  "Finalists will perform a theatrical reading of their best-written letter.",
  "The letter can be their own or a famous literary letter, but it must be performed with personal expression.",
  "Participants can use voice modulation, background music, or simple props for dramatic effect.",
],
    heading3: ["Prizes"],
    prizes: [
    ...
    subheading3: [],
    ruleBook :["./Likhe_Jo_Khat_Tujhe_RuleBook.pdf"]
  },
...

  {
    ...
    iconBg: "#383E56",
    time : ["Time and Venue"],
    timeDetails : ["10-04-2025, 09:00-12:00, New Auditorium"],
    heading: ["About"],
    point: [
    ...
    ruleBook :["./HBTU_Youth_Parliament_RuleBook.pdf"]
  },
...

  {
    ...
    heading: ["About"],
    time : ["Time and Venue"],
    timeDetails : ["10-04-2025, 12:00-12:20, New Auditorium"],
    point: [
      "Lights, Camera, Trivia! Are you a movie buff who knows every iconic scene, legendary dialogue, and behind-the-scenes secret? Put your film knowledge to the test and battle it out for the ultimate trivia champion title!",
    ],
    heading1: ["Guidelines"],
    subheading1: [],
    rules: [
  "This event consists of 5 rounds and welcomes individual participation.",
  "Some rounds may include special challenges such as picture identification or audio clips."
   ],
    heading2: ["Rounds"],
    // judging0: [],
    subheading2: ["Round 1: Identify the Movie from the Famous Dialogue"],
judging: [
  "A famous dialogue will be displayed.",
  "Players must identify the movie name from it.",
  "Time to react - 20 seconds."
],

subheading21: ["Round 2: Guess the Movie Poster"],
judging1: [
  "A cropped or zoomed-in part of a movie poster will be shown.",
  "Players must guess the name of the movie.",
  "Time to react - 25 seconds."
],

subheading22: ["Round 3: Guess the Movie from Characters"],
judging12: [
  "The name of the famous movie character will be announced.",
  "Players have to guess the movie name from it.",
  "For example: Bunny & Aditi - 'Yeh Jawaani Hai Deewani'.",
  "Time to react - 20 seconds."
],

rules2Heading: ["Round 4: Guess the Movie from Emoji"],
rules2: [
  "The game represents a series of emojis that, when combined, hint at the movie title.",
  "Players must decode the emoji to identify the correct film.",
  "Time to react - 15 seconds."
],

rules5Heading: ["Round 5: Guess the Movie from Its Song"],
rules5: [
  "The most common method is to either play short audio clips of well-known movie songs or present key lyrics from the song.",
  "Players must guess the movie name based on the song.",
  "For example: Kabira - 'Yeh Jawaani Hai Deewani'.",
  "Time to react - 15 seconds."
],
...

  {
    ...
    heading: ["About"],
    time : ["Time and Venue"],
    timeDetails : ["10-04-2025, 12:20-03:20, New Auditorium"],
    point: [""],
    heading1: ["Guidelines"],
  ...
  
  {
    ...
    heading: ["About"],
    time : ["Time and Venue"],
    timeDetails : ["10-04-2025, 03:00-04:30, New Auditorium"],
    point: [
    ...
    rules: [
  "The scoring will be based on different events.",
  "The participants will have to participate in other events of the Literary Sub Council.",
  "Slam Poetry takes the weightage of 15 points.",
  "Word War (Debate) takes the weightage of 20 points.",
  "Youth Parliament takes the weightage of 15 points.",
  "Scoring Criteria: Creativity, knowledge, humor, stage presence, and audience engagement.",
  "The participant who scores the highest in the whole event wins the prize.",
  "Now moving towards the half part of the main event.",
],

    heading2: ["Rounds"],
    // judging0: [],
subheading2: ["Round 1: Literary Ramp Walk"],
judging: [
  "Contestants dress as famous literary characters and introduce themselves with a creative monologue.",
  "Points: 10"
],

subheading21: ["Round 2: Bookish Treasure Hunt"],
judging1: [
  "A scavenger hunt where clues are based on famous literary quotes or book characters hidden around campus.",
  "Points: 10"
],

subheading22: ["Round 3: Mystery Puzzle Round"],
judging12: [
  "A Sherlock Holmes-style challenge where contestants solve a mystery using literary clues.",
  "Points: 10"
],

rules2Heading: ["Round 4: Literary Meme Challenge"],
rules2: [
  "Contestants create memes based on book characters or plots and present them humorously.",
  "Points: 10"
],

rules5Heading: ["Round 5: The Grand Quiz"],
rules5: [
  "Questions on literature, famous authors, and literary history.",
  "Points: 10"
],
