  ...
  >
    ...
    >
      ...
      <ul className="mt-3 list-disc ml-5 space-y-2">
        ...
        {feedbacks.judging0 ? (
          <ul className="text-sm m-5 list-disc">
      ...
      <ul className="text-fuchsia-600 text-sm mt-4 select-none  ">
       ...
       {feedbacks.judging12 ? (
        <ul className="mt-3 list-disc ml-5 space-y-2">
        {feedbacks.judging12.map((rule, index) => (
          <li
            key={`experience-point-${index}`}
            className="text-white-100 text-[14px] pl-1 tracking-wider"
          >
      ...
      {feedbacks.rules5 ? (
       <ul className="mt-3 list-disc ml-5 space-y-2">
        {feedbacks.rules5.map((rule, index) => (
          <li
            key={`experience-point-${index}`}
            className="text-white-100 text-[14px] pl-1 tracking-wider"
          >
        ...
        {feedbacks.prizes.map((prize, index) => (
          ...
          >
            {prize}
              ...
              {feedbacks.ruleBook ? (<button
                  className="bg-purple-500 p-2 rounded-lg hover:bg-purple-800"
                  onClick={() => openPdf(feedbacks.ruleBook)}
                >
                  RuleBook
                </button>) : null
              }
